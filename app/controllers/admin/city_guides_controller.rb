class Admin::CityGuidesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @city_guide.save
        format.html { redirect_to admin_city_guide_path(@city_guide), notice: 'City guide was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @city_guide.update_attributes(params[:city_guide])
        format.html { redirect_to admin_city_guide_path(@city_guide), notice: 'City guide was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_city_guides_path }
      format.json { head :no_content }
    end
  end
end
