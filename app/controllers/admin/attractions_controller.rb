class Admin::AttractionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attraction.save
        format.html { redirect_to admin_attraction_path(@attraction), notice: 'Attraction was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @attraction.update_attributes(params[:attraction])
        format.html { redirect_to admin_attraction_path(@attraction), notice: 'Attraction was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_attractions_path }
      format.json { head :no_content }
    end
  end
end
